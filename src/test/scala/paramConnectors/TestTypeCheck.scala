...
//      "© 0 -> 0")
      "∀x:I . 2 * x -> 2 * x | ((2 * x) >= 0) & ((2 * x) >= 0) & ((2 * (x * x)) >= 0) & ((2 * (x * x)) >= 0)",
//      "∀x:I . 2 * x -> 2 * x")
      "© 0 -> 0")
    testOK( unzip ,
...
//      "∀x:I . 2 * x -> 2 * x")
      "© 0 -> 0")
    testOK( sequencer ,
      "∀z:I . (1^z) * x9 -> (1^z) * (0^z) | ((x4 + x10) == ((1 * z) + x13)) & ((2 * z) == x3) & (1 >= 0) & (2 >= 0) & ((x3 + ((2 * z) * (z - 1))) == (((2 * z) * (z - 1)) + (2 * z))) & ((x4 + ((2 * z) * (z - 1))) == x2) & (x3 >= 0) & (x4 >= 0) & (((2 * z) + ((2 * z) * (z - 1))) == x1) & (x1 == Σ{0 ≤ y < z}(((y + 1) + (2 * ((z - y) - 1))) + (y + 1))) & (x2 == Σ{0 ≤ y < z}(((y + 1) + (2 * ((z - y) - 1))) + (y + 1))) & (x1 >= 0) & (x2 >= 0) & ((x9 + z) == ((z - 1) + 1)) & ((x10 + z) == x8) & (x9 >= 0) & (x10 >= 0) & ((2 + (2 * (z - 1))) == x7) & ((1 + (z - 1)) == (1 + (1 * (z - 1)))) & (1 == 1) & (1 >= 0) & (1 >= 0) & (1 >= 0) & (2 >= 0) & (1 == 1) & (1 >= 0) & (1 >= 0) & (1 >= 0) & (2 >= 0) & ((x7 + ((2 * z) * (z - 1))) == (((2 * z) * (z - 1)) + (2 * z))) & ((x8 + ((2 * z) * (z - 1))) == x6) & (x7 >= 0) & (x8 >= 0) & (((2 * z) + ((2 * z) * (z - 1))) == x5) & (x5 == Σ{0 ≤ y < z}(((y + 1) + (2 * ((z - y) - 1))) + (y + 1))) & (x6 == Σ{0 ≤ y < z}(((y + 1) + (2 * ((z - y) - 1))) + (y + 1))) & (x5 >= 0) & (x6 >= 0) & (x14 == (2 * z)) & ((x13 + ((2 * z) * (z - 1))) == (((2 * z) * (z - 1)) + (2 * z))) & ((x14 + ((2 * z) * (z - 1))) == x12) & (x13 >= 0) & (x14 >= 0) & (((2 * z) + ((2 * z) * (z - 1))) == x11) & (x11 == Σ{0 ≤ y < z}(((z - y) + (2 * y)) + (z - y))) & (x12 == Σ{0 ≤ y < z}(((z - y) + (2 * y)) + (z - y))) & (x11 >= 0) & (x12 >= 0) & (2 >= 0) & (0 >= 0)",
//      "∀z:I . z -> z",
...
//      "© 0 -> 0")
      //
      "∀z:I . z -> z | ((2 * z) >= 0) & ((2 * z) >= 0) & ((2 * (z * z)) >= 0) & ((2 * (z * z)) >= 0) & (z >= 0) & ((2 * z) >= 0) & ((2 * z) >= 0) & ((2 * (z * z)) >= 0) & ((2 * (z * z)) >= 0) & ((2 * z) >= 0) & ((2 * z) >= 0) & ((2 * (z * z)) >= 0) & ((2 * (z * z)) >= 0)",
//      "∀z:I . z -> z")
      "© 0 -> 0")

    testOK(  lam (y, Prim("c",0,3)^y) & lam(x,Prim("merger-n",x,1)) ,
      "∀y:I,x:I . 0^y -> 1 | ((3 * y) == x) & (0 >= 0) & (3 >= 0) & (x >= 0) & (1 >= 0)",
      "∀y:I,x:I . 0 -> 1 | ((3 * y) >= 0) & (x == (3 * y))",
      "© 0 -> 1"
    )
